const Progress = props => {
    return (
            ...
            <div className={`progress ${props.className}`} style={{...(props.overstyle ? props.overstyle : {}), overflow: "hidden", height: (props.height ? props.height : "9px"), width: (props.width ? props.width : "100px"), display:"inline-block", position: (props.position ? props.position : "static")}}>
                {/* {props.label ? (
                    <label for="avg">
